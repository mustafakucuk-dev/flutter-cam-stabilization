...
void main() {
  ...
  test('VideoStabilizationMode enum should have items in correct index', () {
    ...
    expect(values[1], VideoStabilizationMode.standard);
    expect(values[2], VideoStabilizationMode.cinematic);
    expect(values[3], VideoStabilizationMode.cinematicExtended);
  });
