  ...
  public interface Camera2CameraInfoHostApi {
    ...
    static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable Camera2CameraInfoHostApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.Camera2CameraInfoHostApi.getAvailableVideoStabilizationModes", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ...
                Number identifierArg = (Number) args.get(0);
                try {
                  List<Long> output = api.getAvailableVideoStabilizationModes((identifierArg == null) ? null : identifierArg.longValue());
                  wrapped.add(0, output);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
