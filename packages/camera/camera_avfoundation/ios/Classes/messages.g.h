...
- (void)setVideoStabilizationMode:(FCPPlatformVideoStabilizationMode)mode completion:(void (^)(FlutterError *_Nullable))completion;
/// Sets the video stabilization mode.
- (void)isVideoStabilizationModeSupported:(FCPPlatformVideoStabilizationMode)mode completion:(void (^)(NSNumber *_Nullable, FlutterError *_Nullable))completion;
